# Fundamentos de Java para Principiantes – SmartCrop (EcoCrop)
...
* **Herramientas necesarias**: ¡Solo tu navegador web! (Usaremos **OnlineGDB**)
* **📂 Repositorio de código fuente**: `https://github.com/<tu_usuario>/java-fundamentals-course-smartcrop` (Reemplaza `<tu_usuario>` por tu usuario real de GitHub)
...
* **Código Fuente Completo**: `https://github.com/<tu_usuario>/java-fundamentals-course-smartcrop`
...
* **NRC/Sección**: `[Completar NRC]`
* **Startup/Equipo**: SmartCrop
* **Producto**: EcoCrop
...
* **Plan de curso (.pdf)**: `upc-pre-202520-1asi0729-[NRC]-smartcrop-course-plan.pdf`
* **Participant Performance Report (.docx y .pdf)**: `upc-pre-202520-1asi0729-[NRC]-smartcrop-course-plan-performance.docx` (y .pdf)
* **Repo GitHub público**: `java-fundamentals-course-smartcrop`

Asegúrate de que todos los videos estén **No listados** en YouTube y que cada lección tenga su enlace a la práctica online precargada en OnlineGDB.